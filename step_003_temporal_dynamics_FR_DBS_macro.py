# -*- coding: utf-8 -*-
"""
Created on Tue Mar 22 12:39:29 2022
...
for idx_chan in range(6):
    for idx_pat in range(7):
            ...
            axs[idx_chan_reverse[idx_chan],idx_pat].plot(t_macro,data_recall[idx_pat,idx_chan,:],color='r')
            ...
            axs[idx_chan_reverse[idx_chan],idx_pat].set_xlim(-3.5, 5.5)
...
plt.savefig('C:/WNencki/processing/dbs_macro/dbs_macro_results/temporal_dynamics_FR/DBS_sub_210527_macro_temporal_dynamics_SME_theta.png', bbox_inches = 'tight', pad_inches = 0.05)
...
plt.savefig('C:/WNencki/processing/dbs_macro/dbs_macro_results/temporal_dynamics_FR/DBS_sub_210527_macro_temporal_dynamics_SME_HG.png', bbox_inches = 'tight', pad_inches = 0.05)